        ...
        <form action="{{ route("submit_add_data_member") }}" method="POST" class="w-full h-full bg-white border shadow-xl p-5 rounded-lg">
            ...
            <div class="flex w-full mb-3 gap-5">
                <div class="input-group flex flex-col gap-2 w-full">
                    ...
                    <input name="phone" id="phone" type="number" class="w-full border border-black rounded-lg p-3 h-[45px] text-slate-500 text-lg font-semibold" placeholder="Masukkan no telepon">
                </div>
