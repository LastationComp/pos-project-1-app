    ...
    <div class="wrapper w-[60%] h-fit bg-[#c9c2c2] rounded-lg  relative left-1/2 -translate-x-1/2 border shadow-xl mt-12 p-3">
        <form action="{{ url('employee/member') }}" method="POST" class="w-full h-full bg-white border shadow-xl p-5 rounded-lg">
            ...
            <div class="input-group flex flex-col gap-2 mb-3">
                ...
                <input name="point" value="512" id="point" type="text" class="w-full border border-black rounded-lg p-3 h-[45px] text-slate-500 text-lg font-semibold" placeholder="Masukkan point member">
            </div>

            <div class="input-group flex flex-col gap-2 mb-3">
                <label for="name" class="text-xl font-semibold">Name</label>
                <input name="name" value="Evan Nurhadi" id="name" type="text" class="w-full border border-black rounded-lg p-3 h-[45px] text-slate-500 text-lg font-semibold" placeholder="Masukkan nama member baru">
            </div>
            ...
            <div class="flex w-full mb-3 gap-5">
                <div class="input-group flex flex-col gap-2 w-full">
                    ...
                    <input name="phone" value="0834-8881-2073" id="phone" type="text" class="w-full border border-black rounded-lg p-3 h-[45px] text-slate-500 text-lg font-semibold" placeholder="Masukkan no telepon">
                </div>

                <div class="input-group flex flex-col gap-2 w-full">
                    <label for="email" class="text-xl font-semibold">Email</label>
                    <input name="email" value="evan@gmail.com" id="email" type="text" class="w-full border border-black rounded-lg p-3 h-[45px] text-slate-500 text-lg font-semibold" placeholder="Masukkan email">
                </div>
            </div>
