...
@section('content')
    <div class="px-[100px] py-[25px]">
        ...
        <form action="{{route('submit_profile_update', $dataAdmin[0]->username)}}"class="max-w-2xl" method="POST">
            ...
            <button data-confirm-delete="true" type="submit" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Save</button>
          </form>
    </div>
@endsection
